...
\begin{figure}
\begin{center}
\subfigure[Mechanism of clustering]{\includegraphics[scale=1]{\docroot introduction/figs/chezclustering}}\\
\subfigure[Dynamic range improvement]{\includegraphics[scale=1]{\docroot introduction/figs/chezdynamics}}
\caption{stuff}
\end{center}
\end{figure}
