...
\caption[PCR results for Gibson Assembly]{PCR to create overlaps for Gibson Assembly. \subref{fig:results:gibson:A206K}, \subref{fig:results:gibson:49} and \subref{fig:results:gibson:289}: schematics of plasmid templates. \subref{fig:results:gibson:pcr}: agarose gel of PCR products, with desired bands circled n red. pWAC1 was created by Gibson Assembly from circled, gel purified bands from lanes 3, 4 and 5; pWAC4 from lanes 3, 5 and 6.}
