...
\begin{tabular}{lllcc}
\bfseries Plasmid Name &
\bfseries Gene &
\bfseries Backbone &
\bfseries Antibiotic &
\bfseries Inducer
\DTLforeach{#1}{\plasmidname=Plasmid Name,\gene=Gene,\backbone=Backbone,\antibiotic=Antibiotic,\inducer=Inducer}{\\\textbf{\plasmidname} & \textit{\gene} & \backbone & \antibiotic & \inducer}
\end{tabular}}

\bibliography{\docroot refs}

\title{Something Something Chemotaxis Something Microscopy}
\date{June 2012}
