...
The final resuspension volume was be adjusted to match cell density depending on mounting method. Initial volume was also be adjusted with corresponding changes to subsequent volumes. Concentratin of \ce{CoSO4} was varied according to requirements.
...
\begin{figure}[p]
\begin{center}
\subfloat[Raw B\&W image]{
	\includegraphics[scale=0.3]{\docroot matmeth/figs/slide1}
	\label{fig:imageprocessing:raw}
}
\subfloat[Edge detection]{
	\includegraphics[scale=0.3]{\docroot matmeth/figs/slide2}
	\label{fig:imageprocessing:edges}
}\\
\subfloat[Detected Cells]{
	\includegraphics[scale=0.3]{\docroot matmeth/figs/slide3}
	\label{fig:imageprocessing:cells}
}
\subfloat[Accepted Cells]{
	\includegraphics[scale=0.3]{\docroot matmeth/figs/slide4}
