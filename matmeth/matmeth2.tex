...
\subfloat[Raw greyscale image]{
	\includegraphics[scale=0.65]{\docroot matmeth/figs/slide1}
	\label{fig:imageprocessing:raw}
}
\subfloat[Edge detection]{
	\includegraphics[scale=0.65]{\docroot matmeth/figs/slide2}
	\label{fig:imageprocessing:edges}
}\\
\subfloat[Detected Cells]{
	\includegraphics[scale=0.65]{\docroot matmeth/figs/slide3}
	\label{fig:imageprocessing:cells}
}
\subfloat[Accepted Cells]{
	\includegraphics[scale=0.65]{\docroot matmeth/figs/slide4}
